	...
	return (
		<Dialog>
			...
			<DialogContent className="sm:max-w-[625px]">
				<DialogHeader>
					<DialogTitle className="w-5/6">Skattedirektoratets trekkfire satser – inn- og utland 2025</DialogTitle>
				</DialogHeader>
				...
				<Table>
					<TableBody>
						...
						<TableRow>
							<TableCell>
								Døgndiett på yrkesreise/ tjenestereise ved annen overnatting med kokemuligheter (eks. hybel, brakke,
								privat overnatting)
							</TableCell>
